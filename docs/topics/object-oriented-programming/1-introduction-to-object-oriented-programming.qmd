...
This is a brief introduction to Object-Oriented Programming (OOP). This is not an exhaustive guide to OOP. Our goal is to provide a sufficient overiew to enable our discussion on OOP in Python.
