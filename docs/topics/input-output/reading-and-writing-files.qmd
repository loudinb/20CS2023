...
Using the attached [starter code](hands_on_word_counter.py), write a Python program that reads a text file, counts the number of each word, and prints the results.

**Text file**: [atotc.txt](atotc.txt)
...
Using the attached [starter code](hands_on_bmp_image_conversion.py), write a Python program that reads a BMP image file and converts it to greyscale, saving the result as a new image file.

**BMP image**: [rainier.bmp](rainier.bmp)
...
Using the attached [starter code](hands_on_json.py), write a Python program that reads a JSON file and stores the content as a dictionary. Then, iterate over the dictionary and print the key-value pairs. 

**JSON file**: [people.json](people.json)